    ...
    class DungeonRunStats():
        ...
        def get_stats_str(self):
            return (
                ...
                f"**Underworld:**\n\n"
                f"Rooms Explored: *{self.underworld_rooms_explored}*\n"
                f"Combat Encounters: *{self.underworld_combat_encounters}*\n"
                f"Treasure Rooms Found: *{self.underworld_treasure_rooms_encountered}*\n"
                f"Shopkeepers Met: *{self.underworld_shopkeeps_encountered}*\n"
                f"Events Encountered: *{self.underworld_events_encountered}*\n"
                f"Rests Taken: *{self.underworld_rests_taken}*\n"
                f"Bosses Defeated: *{self.underworld_bosses_defeated}*\n"
                f"Adventures Won: *{self.underworld_adventures_won}*\n"
                f"Adventures Played: *{self.underworld_adventures_played}*\n"
