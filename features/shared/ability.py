...
class Ability():
    def __init__(self, icon: str, name: str, class_key: ExpertiseClass, description: str, flavor_text: str, mana_cost: int, cooldown: int, num_targets: int, level_requirement: int, target_own_group: bool, purchase_cost: int, scaling: List[Attribute], alt_currency: ItemKey | None=None):
        self._icon = icon
        self._name = name
...
class ShatteringStormI(Ability):
    def __init__(self):
        super().__init__(
            ...
            class_key=ExpertiseClass.Fisher,
            description="Invoke the tempest against up to 3 enemies, dealing 40-50 damage with a 20% chance for each to lose their next turn.",
            flavor_text="",
            mana_cost=150,
            cooldown=5,
            num_targets=3,
...
class ShatteringStormII(Ability):
    def __init__(self):
        super().__init__(
            ...
            class_key=ExpertiseClass.Fisher,
            description="Invoke the tempest against up to 3 enemies, dealing 50-60 damage with a 40% chance for each to lose their next turn.",
            flavor_text="",
            mana_cost=150,
            cooldown=5,
            num_targets=3,
...
class ShatteringStormIII(Ability):
    def __init__(self):
        super().__init__(
            ...
            class_key=ExpertiseClass.Fisher,
            description="Invoke the tempest against up to 3 enemies, dealing 60-70 damage with a 60% chance for each to lose their next turn.",
            flavor_text="",
            mana_cost=150,
            cooldown=5,
            num_targets=3,
...
class ToxicCloudI(Ability):
    def __init__(self):
        super().__init__(
            ...
            name="Toxic Cloud I",
            class_key=ExpertiseClass.Alchemist,
            description="Create a miasma that deals 1-3 damage to all enemies with a 30% chance to Poison them for the next 2 turns.",
            flavor_text="",
            mana_cost=5,
            cooldown=2,
            num_targets=-1,
...
class ToxicCloudII(Ability):
    def __init__(self):
        super().__init__(
            ...
            name="Toxic Cloud II",
            class_key=ExpertiseClass.Alchemist,
            description="Create a miasma that deals 2-4 damage to all enemies with a 50% chance to Poison them for the next 2 turns.",
            flavor_text="",
            mana_cost=5,
            cooldown=2,
            num_targets=-1,
...
class ToxicCloudIII(Ability):
    def __init__(self):
        super().__init__(
            ...
            class_key=ExpertiseClass.Alchemist,
            description="Create a miasma that deals 3-5 damage to all enemies with a 70% chance to Poison them for the next 2 turns.",
            flavor_text="",
            mana_cost=5,
            cooldown=2,
            num_targets=-1,
...
class ToxicCloudIV(Ability):
    def __init__(self):
        super().__init__(
            ...
            name="Toxic Cloud IV",
            class_key=ExpertiseClass.Alchemist,
            description="Create a miasma that deals 4-6 damage to all enemies with a 90% chance to Poison them for the next 2 turns.",
            flavor_text="",
            mana_cost=5,
            cooldown=2,
            num_targets=-1,
...
class CorruptionI(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83D\uDDA4",
            name="Corruption I",
            class_key=ExpertiseClass.Fisher,
            description="Cause up to 2 enemies to gain 1 stack of Corruption.",
            flavor_text="",
            mana_cost=10,
            cooldown=0,
            num_targets=1,
            ...
            purchase_cost=1,
            scaling=[],
            alt_currency=ItemKey.VoidseenOre
        )
...
class CorruptionII(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83D\uDDA4",
            name="Corruption II",
            class_key=ExpertiseClass.Fisher,
            description="Cause up to 2 enemies to gain 2 stacks of Corruption.",
            flavor_text="",
            mana_cost=10,
            cooldown=0,
            num_targets=1,
...
class CorruptionIII(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83D\uDDA4",
            name="Corruption III",
            class_key=ExpertiseClass.Fisher,
            description="Cause up to 2 enemies to gain 3 stacks of Corruption.",
            flavor_text="",
            mana_cost=10,
            cooldown=0,
            num_targets=1,
...
class ConversionI(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83D\uDD04",
            name="Conversion I",
            class_key=ExpertiseClass.Fisher,
            description="Choose an enemy. Remove all of your status effects and give the target that many stacks of Corruption.",
            flavor_text="",
            mana_cost=30,
            cooldown=7,
            num_targets=1,
    ...
    def use_ability(self, caster: Player | NPC, targets: List[Player | NPC]) -> str:
        ...
        debuff = Corrupted(
            turns_remaining=-1,
            value=len(caster.get_dueling().status_effects),
            source_str=self.get_icon_and_name()
        )

        caster.get_dueling().status_effects = []
        caster.get_expertise().update_stats(caster.get_combined_attributes())
        result_str += "{0} has had their status effects removed"
...
class UncannyWhispersI(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83D\uDC44",
            name="Uncanny Whispers I",
            class_key=ExpertiseClass.Fisher,
            description="Whisper into the mind of an enemy, dealing 10-20 damage and giving them 2 stacks of Corruption.",
            flavor_text="",
            mana_cost=20,
            cooldown=4,
            num_targets=1,
    ...
    def use_ability(self, caster: Player | NPC, targets: List[Player | NPC]) -> str:
        ...
        result_str: str = "{0}" + f" cast {self.get_icon_and_name()}!\n\n"
        results: List[NegativeAbilityResult] = self._use_damage_and_effect_ability(caster, targets, range(10, 20), [debuff])
        result_str += "\n".join(list(map(lambda x: x.target_str, results)))
...
class UncannyWhispersII(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83D\uDC44",
            name="Uncanny Whispers II",
            class_key=ExpertiseClass.Fisher,
            description="Whisper into the mind of an enemy, dealing 20-30 damage and giving them 2 stacks of Corruption.",
            flavor_text="",
            mana_cost=20,
            cooldown=4,
            num_targets=1,
...
class UncannyWhispersIII(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83D\uDC44",
            name="Uncanny Whispers III",
            class_key=ExpertiseClass.Fisher,
            description="Whisper into the mind of an enemy, dealing 30-40 damage and giving them 2 stacks of Corruption.",
            flavor_text="",
            mana_cost=20,
            cooldown=4,
            num_targets=1,
...
class VoidformI(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83C\uDF0C",
            name="Voidform I",
            class_key=ExpertiseClass.Fisher,
            description="Let the void flow through you, causing you to take 50% additional damage and deal 50% additional damage for 2 turns. Additionally, set 100% Decaying on yourself for 2 turns.",
            flavor_text="",
            mana_cost=30,
            cooldown=6,
            num_targets=0,
    ...
    def use_ability(self, caster: Player | NPC, targets: List[Player | NPC]) -> str:
        ...
        result_str: str = "{0}" + f" cast {self.get_icon_and_name()}!\n\n"
        results: List[str] = self._use_positive_status_effect_ability(caster, targets, [dmg_vuln, dmg_buff, decaying])
        result_str += "\n".join(results)
...
class ControlI(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83E\uDDE0",
            name="Control I",
            class_key=ExpertiseClass.Fisher,
            description="Consume 3 stacks of Corruption on an enemy to cause them to be Charmed for 1 turn.",
            flavor_text="",
            mana_cost=75,
            cooldown=5,
            num_targets=1,
    ...
    def use_ability(self, caster: Player | NPC, targets: List[Player | NPC]) -> str:
        ...
        for target in targets:
            corruption_se = next(se for se in target.get_dueling().status_effects if se.key == StatusEffectKey.Corrupted)
            if corruption_se.value >= 3:
                corruption_se.value -= 3
...
class ControlII(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83E\uDDE0",
            name="Control II",
            class_key=ExpertiseClass.Fisher,
            description="Consume 2 stacks of Corruption on an enemy to cause them to be Charmed for 1 turn.",
            flavor_text="",
            mana_cost=75,
            cooldown=5,
            num_targets=1,
    ...
    def use_ability(self, caster: Player | NPC, targets: List[Player | NPC]) -> str:
        ...
        for target in targets:
            corruption_se = next(se for se in target.get_dueling().status_effects if se.key == StatusEffectKey.Corrupted)
            if corruption_se.value >= 2:
                corruption_se.value -= 2
                filtered_targets.append(target)
...
class ControlIII(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83E\uDDE0",
            name="Control III",
            class_key=ExpertiseClass.Fisher,
            description="Consume 1 stack of Corruption on an enemy to cause them to be Charmed for 1 turn.",
            flavor_text="",
            mana_cost=75,
            cooldown=5,
            num_targets=1,
    ...
    def use_ability(self, caster: Player | NPC, targets: List[Player | NPC]) -> str:
        ...
        for target in targets:
            corruption_se = next(se for se in target.get_dueling().status_effects if se.key == StatusEffectKey.Corrupted)
            if corruption_se.value >= 1:
                corruption_se.value -= 1
                filtered_targets.append(target)
...
class MindSpikeI(Ability):
    def __init__(self):
        super().__init__(
            icon="\u2604\uFE0F",
            name="Mind Spike I",
            class_key=ExpertiseClass.Fisher,
            description="Deal damage to up to 2 enemies equal to 4 times their stacks of Corruption. Consume those stacks of Corruption.",
            flavor_text="",
            mana_cost=100,
            cooldown=3,
            num_targets=2,
    ...
    def use_ability(self, caster: Player | NPC, targets: List[Player | NPC]) -> str:
        ...
        for i, target in enumerate(targets):
            ...
            corruption_se = next(se for se in target.get_dueling().status_effects if se.key == StatusEffectKey.Corrupted)
            target.get_dueling().status_effects = [se for se in target.get_dueling().status_effects if se.key != StatusEffectKey.Corrupted]
            ...
            critical_hit_final = max(critical_hit_boost + critical_hit_dmg_buff, 1) if critical_hit_boost > 1 else 1
            base_damage = int(corruption_se.value * 4)
...
class MindSpikeII(Ability):
    def __init__(self):
        super().__init__(
            icon="\u2604\uFE0F",
            name="Mind Spike II",
            class_key=ExpertiseClass.Fisher,
            description="Deal damage to up to 2 enemies equal to 8 times their stacks of Corruption. Consume those stacks of Corruption.",
            flavor_text="",
            mana_cost=100,
            cooldown=3,
            num_targets=2,
    ...
    def use_ability(self, caster: Player | NPC, targets: List[Player | NPC]) -> str:
        ...
        for i, target in enumerate(targets):
            ...
            critical_hit_final = max(critical_hit_boost + critical_hit_dmg_buff, 1) if critical_hit_boost > 1 else 1
            base_damage = int(corruption_se.value * 8)
...
class MindSpikeIII(Ability):
    def __init__(self):
        super().__init__(
            icon="\u2604\uFE0F",
            name="Mind Spike III",
            class_key=ExpertiseClass.Fisher,
            description="Deal damage to up to 2 enemies equal to 12 times their stacks of Corruption. Consume those stacks of Corruption.",
            flavor_text="",
            mana_cost=100,
            cooldown=3,
            num_targets=2,
    ...
    def use_ability(self, caster: Player | NPC, targets: List[Player | NPC]) -> str:
        ...
        for i, target in enumerate(targets):
            ...
            critical_hit_final = max(critical_hit_boost + critical_hit_dmg_buff, 1) if critical_hit_boost > 1 else 1
            base_damage = int(corruption_se.value * 12)
