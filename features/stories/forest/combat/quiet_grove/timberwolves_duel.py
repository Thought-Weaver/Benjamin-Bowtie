...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [Timberwolf(" 1"), Timberwolf(" 2"), Timberwolf(" 3")], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
