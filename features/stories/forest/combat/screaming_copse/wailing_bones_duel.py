...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: WailingBonesDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [WailingBones()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class WailingBonesDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Otherworldly Shrieks", description="In a gale of dust, racing along the remains of the path comes a vortex of various bones, some burnt with a distinct dark purplish flame. It shows no sign of slowing -- and no signs of being amenable to your continued existence.")
