...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Truly Dead?", description=f"With the undead treants vanquished, the rest of the woods await.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: UndeadTreantsDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [ColossalUndeadTreant(), DesiccatedUndeadTreant()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class UndeadTreantsDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Dead Trees Rise", description="Amid the bleak greys and browns of the dead trees surrounding you, two of them suddenly begin to shift. The three hollow eyes of two undead treants turn to face you!")
