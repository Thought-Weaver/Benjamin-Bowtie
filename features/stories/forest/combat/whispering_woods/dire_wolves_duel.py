...
from features.stories.forest.combat.npcs.dire_wolf import DireWolf
...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="In Dire Straits", description=f"With the dire wolves vanquished, the rest of the woods await.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [DireWolf(" 1"), DireWolf(" 2")], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class DireWolvesDuelView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="A Howl and a Leap", description="From the woods, two hulking figures emerge, eyes glowing yellow: dire wolves!")
