...
from features.stories.forest.combat.npcs.mad_knight import MadKnight
...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Silence at Last", description=f"With the mad knights vanquished, the rest of the woods await.")
...
class MadKnightsDuelView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="A Scream of Insanity", description="Running from down the path, clutching their ears, are two fully armored knights with grand swords. As they approach, they begin to slow, but never stop screaming -- then they take up their weapons and begin to charge!")
