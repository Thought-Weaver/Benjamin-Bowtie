...
from features.stories.forest.combat.npcs.armored_centipede import ArmoredCentipede
...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Back to the Earth", description=f"With the armored centipede vanquished, the rest of the woods await.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: ArmoredCentipedeDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [ArmoredCentipede()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class ArmoredCentipedeDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Quaking Earth", description="From below you, there's suddenly a rumbling and shaking of the ground -- as erupting from the earth emerges an armored centipede!")
