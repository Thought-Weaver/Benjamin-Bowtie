...
from features.shared.ability import BidedAttackIII, CounterstrikeIII, EvadeII
...
class Thief(NPC):
    def __init__(self):
        super().__init__("Thief", NPCRoles.DungeonEnemy, NPCDuelingPersonas.Rogue, {
            ...
            ItemKey.Leather: 0.8,
            ItemKey.DaggerOfTheHemocrafter: 0.02
        })
    ...
    def _setup_abilities(self):
        ...
        self._dueling.abilities = [EvadeII(), CounterstrikeIII(), BidedAttackIII()]
