...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: ScreamingCopseTreasureRoomView = self.view
...
class ScreamingCopseTreasureRoomView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Scattered Treasure", description=f"Deep in the forest, you find the remains of adventurers like yourselves, their belongings now among the undead roots of these accursed trees.\n\n{self._treasure_result_str}")
