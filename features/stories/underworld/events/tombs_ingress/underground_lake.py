...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: TombsIngressUndergroundLakeView = self.view
...
class TombsIngressUndergroundLakeView(discord.ui.View):
    ...
    def fish(self, user: discord.User):
        ...
        rand_val = random.choices(
            [0, 1, 2, 3, 4], k=1,
            weights=[
                0.2 - LUCK_MOD * total_luck,
                0.2 + 6 * (LUCK_MOD * total_luck) / 16,
                0.25 + 4 * (LUCK_MOD * total_luck) / 16,
                0.2 + 3 * (LUCK_MOD * total_luck) / 16,
                0.15 + 2 * (LUCK_MOD * total_luck) / 16
            ]
        )[0]
