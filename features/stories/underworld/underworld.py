...
class UnderworldDungeonEntranceView(discord.ui.View):
    ...
    def get_initial_embed(self):
        ...
        return discord.Embed(title="The Underworld", description=(
            "Late into the evening, as you're enjoying some time at the tavern, the entrance is opened carefully and quietly. Who should step through but Yenna, with a look of concern clear on her face. She beckons you all to come to her tent for a discussion of grave importance.\n\n"
