...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Bats Off to Ya", description=f"With the ichordrink bats vanquished, the rest of the caves await.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: DeadSpelunkerDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [IchordrinkBat(), IchordrinkBat(), IchordrinkBat()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class DeadSpelunkerDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Soft Chittering", description="In the darkness of the tunnels, you all hear a chittering echoing across the rocky walls. Though the fog obscures your view, movement on the ceiling suddenly catches your attention: Two large, cocoon-like forms loom above your party -- and as you approach, their wings begin to unfurl and they screech with fury.")
