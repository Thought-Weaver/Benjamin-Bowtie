...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Apparition Dispelled", description=f"With the misty apparition vanquished, the rest of the caves await.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: MistyApparitionDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [MistyApparition()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class MistyApparitionDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="In the Mist", description="The mists of the cavern have been everpresent on your journey deeper into the darkness, but in this place it almost feels as though they're alive. You could swear something is trying to reach out to you, to grasp you and drag you into the frigid fog. Then you see it: A vague shape, almost humanoid, darker than the rest of the mists, looking at you.")
