...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="The Path Forward", description=f"Having made it past the winding tunnels, the rest of the caves await.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: WindingTunnelsDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [WindingTunnels()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class WindingTunnelsDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Where Next?", description="The paths have become confusing and unclear; you can't seem to find which way to turn or where to go -- every time you think you're going in the right direction, it seems like you end up turned around and even more lost than before. Exploring the options is becoming dangerous and you find yourselves uncertain how to push forward.")
