...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Fog Felled", description=f"Having made it past the dense fog, the rest of the caves await.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: ChokingFogDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [ChokingFog()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class ChokingFogDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Encroaching Mists", description="The mists in this region begin to grow particularly intense, to the point of becoming a dense fog which makes it almost impossible to see. There's a dampness and chill to the fog that seeps into your bones. You can feel consciousness beginning to drift away in the lull of the cold that overcomes you.")
