...
from features.shared.statuseffect import AttrBuffOnDamage, BonusDamageOnAttack, StackingDamage, StatusEffectKey
...
class GrowingMalevolence(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83C\uDF44",
            name="Growing Malevolence",
            class_key=ExpertiseClass.Guardian,
            description="Increase the damage your attacks deal by 50 for the rest of the duel.",
            flavor_text="",
            mana_cost=0,
            cooldown=1,
            num_targets=0,
...
class Counterattack(Ability):
    def __init__(self):
        super().__init__(
            ...
            name="Counterattack",
            class_key=ExpertiseClass.Guardian,
            description="Deal damage to an enemy equal to their max weapon damage.",
            flavor_text="",
            mana_cost=0,
            cooldown=1,
            num_targets=1,
    ...
    def use_ability(self, caster: Player | NPC, targets: List[Player | NPC]) -> str:
        ...
        result_str: str = "{0}" + f" used {self.get_icon_and_name()}, grabbing " + "{1}'s weapon and attacking them with it!\n\n"
...
class FrenzyStrike(Ability):
    def __init__(self):
        super().__init__(
            icon="\uD83D\uDCA5",
            name="Frenzy Strike",
            class_key=ExpertiseClass.Guardian,
            description="Immediately attack all enemies at once!",
            flavor_text="",
            mana_cost=0,
            cooldown=3,
            num_targets=-1,
...
class MalevolentMorel(NPC):
    ...
    def _setup_equipment(self):
        ...
        self._equipment.equip_item_to_slot(ClassTag.Equipment.MainHand, LOADED_ITEMS.get_new_item(ItemKey.MorelTendrils))
    ...
    def _setup_abilities(self):
        ...
        self._dueling.abilities = [Counterattack(), GrowingMalevolence(), FrenzyStrike()]
