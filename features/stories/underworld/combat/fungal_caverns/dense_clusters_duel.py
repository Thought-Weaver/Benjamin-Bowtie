...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="The Path Cleared", description=f"With the mushrooms vanquished, the rest of the caves await.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: DenseClustersDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [AgaricAlchemist(), DeathlessCap(), MalevolentMorel()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class DenseClustersDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="So Many Mushrooms", description="As you move through the mushrooms, clearing and hacking away as much as you can, some of them begin to move. Awakened by your efforts to continue along the path, they reach out to strike!")
