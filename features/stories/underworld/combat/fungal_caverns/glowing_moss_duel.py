...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="A Dim Path Forward", description=f"Having made it past the glowing moss, the rest of the caves await.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: GlowingMossDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [GlowingMoss()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class GlowingMossDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Shimmering Light", description="Across the walls and floors of the corridors you've seen moss and lichen growing in great numbers, but as you continue to wander further in, one section of the moss is glowing blue at its tips. The bioluminescence pulses in waves across it, creating rings that almost lull you into a sense of awe and distraction.")
