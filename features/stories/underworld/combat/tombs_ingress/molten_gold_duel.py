...
from features.stories.underworld.combat.npcs.molten_gold import MoltenGold
...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Inanimate Again", description=f"With the molten gold vanquished, the rest of the caves await.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: MoltenGoldDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [MoltenGold()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class MoltenGoldDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Terrifying Torrent", description="The sound of running water catches your ear and you think that somewhere down here might be a waterfall or river like the mushroom caves beforehand. But, instead, what comes rushing towards you is liquid gold: Barely a creature and more a torrent, burning hot moves forward with a ceaseless determination.")
