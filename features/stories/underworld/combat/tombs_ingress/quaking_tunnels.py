...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Not Your Tomb", description=f"Having made it past the quaking tunnels, the rest of the caves await.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: QuakingTunnelsDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [QuakingTunnels()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class QuakingTunnelsDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Crumbling Caves", description="All around you, the halls begin to rumble -- lightly at first, then more vigorously, a shockwave occurring every so often like the fist of a giant wailing on the walls. It's difficult to keep your balance, even more so as chunks of stone break off from the doorways and rooms, pummeling your party as you try to move forward.")
