...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Open the Chest", description=f"With the waylaid chest vanquished, the rest of the caves await.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: WaylaidChestDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [WaylaidChest()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class WaylaidChestDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="A Small Treasure Room?", description="In a room off to your left, you spy a smattering of gold and gems, as well as a locked chest. It's nothing ornate: Just some wood and iron banded in a purely functional fashion, but it could have some useful items in it for your journey ahead. As you go to open the chest, however, you realize that you can hear it... breathing.")
