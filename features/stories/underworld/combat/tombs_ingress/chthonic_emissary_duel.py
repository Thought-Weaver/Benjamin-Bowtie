...
class ChthonicEmissaryDuelView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="The Inner City", description=(
            ...
            "You can hear the occasional clink of something falling onto the ground from somewhere high above -- and you look up. At first, you just see the ceiling of the cavern, but then a single gold coin manifests from shadow, landing in the pile below.\n\n"
