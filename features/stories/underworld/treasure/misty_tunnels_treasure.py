...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: MistyTunnelsTreasureRoomView = self.view
...
class MistyTunnelsTreasureRoomView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Lost Treasure", description=f"On the corpses of wayward adventurers, you find various items!\n\n{self._treasure_result_str}")
