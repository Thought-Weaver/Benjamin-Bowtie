...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: TombsIngressTreasureRoomView = self.view
...
class TombsIngressTreasureRoomView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Lost Treasure", description=f"On the corpses of some cultists, you find various items!\n\n{self._treasure_result_str}")
