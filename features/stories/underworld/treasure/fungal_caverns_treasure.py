...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: FungalCavernsTreasureRoomView = self.view
...
class FungalCavernsTreasureRoomView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Lost Treasure", description=f"Among the variegated mushrooms, you find various items!\n\n{self._treasure_result_str}")
