...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: HiddenRoomTreasureRoomView = self.view
...
class HiddenRoomTreasureRoomView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Hidden Loot", description=f"With an incredible show of strength, the door is pushed ajar just enough for all of you to slip inside. The room must have either been some kind of collection area or storage room -- you all find some incredible items to aid your journey!\n\n{self._treasure_result_str}")
