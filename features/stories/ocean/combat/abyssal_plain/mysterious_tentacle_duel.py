...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Tentacle Triumph", description=f"With the mysterious tentacle vanquished, the rest of the ocean awaits.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: MysteriousTentacleDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [MysteriousTentacle()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class MysteriousTentacleDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Twist and Bend", description="It strikes you at first that the thing in front of you might be some sort of deep ocean plant life, but something about how it's moving doesn't make sense. As you try to move around it, you notice that the thing is following you. Your party turns around to face a giant tentacle protruding from the ground, no body in sight.")
