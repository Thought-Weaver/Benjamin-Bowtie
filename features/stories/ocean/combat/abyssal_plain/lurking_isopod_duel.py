...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="No More Chittering", description=f"With the lurking isopod vanquished, the rest of the ocean awaits.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: LurkingIsopodDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [LurkingIsopod()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class LurkingIsopodDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Something Scuttles", description="Chittering. Chittering in the shadows of this place. There's something in front of you? No, behind! It's moving too fast to track -- only when it leaps towards you do its many legs and armored carapace at last appear.")
