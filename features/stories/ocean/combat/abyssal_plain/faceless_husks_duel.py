...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="Truly Husks?", description=f"With the faceless husks vanquished, the rest of the ocean awaits.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: FacelessHusksDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [FacelessHusk(), FacelessHusk()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class FacelessHusksDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Strangers in a Strange Place", description="Are those people? No, they can't be -- who else would be down here. Perhaps others were called, the same as you, to find what waits below the waves. If what shambles towards you now were people, though, they certainly aren't now. Kelp, packed sand, and seashells are strewn across a vague humanoid form, their faces devoid of any features.")
