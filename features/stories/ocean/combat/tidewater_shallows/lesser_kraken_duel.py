...
class VictoryView(discord.ui.View):
    ...
    def get_initial_embed(self):
        return Embed(title="What's Kraken", description=f"With the lesser kraken vanquished, the rest of the ocean awaits.")
...
class ContinueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view: LesserKrakenDuelView = self.view
        ...
        duel_view: DuelView = DuelView(view.get_bot(), view.get_database(), view.get_guild_id(), view.get_users(), view.get_players(), [LesserKraken()], player_victory_post_view=victory_view, player_loss_post_view=defeat_view)
...
class LesserKrakenDuelView(discord.ui.View):
    def __init__(self, bot: BenjaminBowtieBot, database: dict, guild_id: int, users: List[discord.User], dungeon_run: DungeonRun):
        super().__init__(timeout=None)
    ...
    def get_initial_embed(self):
        return Embed(title="Tentacles Unfurl", description="In the murky waters, something shoots from the upturned sand and grasps at you! Slowly, more tentacles emerge as the creature unfurls itself against your party.")
