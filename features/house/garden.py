...
SEED_DATA: MappingProxyType[ItemKey, SeedData] = MappingProxyType({
    ...
    ItemKey.GoldberrySeed: SeedData(1, 2, 15, ItemKey.Goldberries, 0.01, 3, "\uD83C\uDF31", 16),
    ItemKey.GoldenAppleSeed: SeedData(1, 2, 15, ItemKey.GoldenApple, 0.01, 3, "\uD83C\uDF31", 16),
...
MUTATION_PROBS: MappingProxyType[Tuple[ItemKey | Literal[""], ItemKey | Literal[""]], Tuple[ItemKey, float]] = MappingProxyType({
    ...
    (ItemKey.DreamMaker, ItemKey.Rotstalk): (ItemKey.WitherheartSeed, 0.02),
    ...
    (ItemKey.DreamMaker, ItemKey.Manabloom): (ItemKey.LichbloomSeed, 0.02),
    (ItemKey.Lichbloom, ItemKey.DragonsTeeth): (ItemKey.ForgottenTearsSeed, 0.03),
    ...
    (ItemKey.FoolsDelight, ItemKey.Bloodcrown): (ItemKey.SpidersGroveSpores, 0.03),
