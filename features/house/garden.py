...
MUTATION_PROBS: MappingProxyType[Tuple[ItemKey | Literal[""], ItemKey | Literal[""]], Tuple[ItemKey, float]] = MappingProxyType({
    (ItemKey.Seaclover, ItemKey.Seaclover): (ItemKey.GraspleafSeed, 0.3),
    (ItemKey.Graspleaf, ItemKey.Seaclover): (ItemKey.BramblefrondSeed, 0.25),
    (ItemKey.Bramblefrond, ItemKey.Graspleaf): (ItemKey.FissureleafSeed, 0.2),
    (ItemKey.Fissureleaf, ItemKey.Seaclover): (ItemKey.RazorgrassSeed, 0.15),
    (ItemKey.Razorgrass, ItemKey.Graspleaf): (ItemKey.GraveMossSpores, 0.13),
    (ItemKey.GraveMoss, ItemKey.Asptongue): (ItemKey.HushvineSeed, 0.07),
    (ItemKey.Hushvine, ItemKey.FoolsDelight): (ItemKey.RotstalkSeed, 0.06),
    (ItemKey.Snowdew, ItemKey.Sungrain): (ItemKey.DawnsGlorySeed, 0.2),
    (ItemKey.DawnsGlory, ItemKey.Snowdew): (ItemKey.RiverblossomSeed, 0.15),
    (ItemKey.Riverblossom, ItemKey.Riverblossom): (ItemKey.ManabloomSeed, 0.08),
    (ItemKey.Manabloom, ItemKey.FoolsDelight): (ItemKey.DreamMakerSeed, 0.06),
    (ItemKey.DreamMaker, ItemKey.Rotstalk): (ItemKey.WitherheartSeed, 0.05),
    (ItemKey.Witherheart, ItemKey.DawnsGlory): (ItemKey.DragonsTeethSeed, 0.07),
    (ItemKey.Witherheart, ItemKey.Manabloom): (ItemKey.MagesBaneSeed, 0.15),
    (ItemKey.DreamMaker, ItemKey.Manabloom): (ItemKey.LichbloomSeed, 0.05),
    (ItemKey.Lichbloom, ItemKey.DragonsTeeth): (ItemKey.ForgottenTearsSeed, 0.05),
    (ItemKey.Snowdew, ItemKey.Seaclover): (ItemKey.FrostwortSeed, 0.3),
    (ItemKey.Frostwort, ItemKey.Snowdew): (ItemKey.ShiverrootSeed, 0.25),
    (ItemKey.Shiverroot, ItemKey.Seaclover): (ItemKey.ShelterfoilSeed, 0.2),
    (ItemKey.Shelterfoil, ItemKey.Shiverroot): (ItemKey.ShellflowerSeed, 0.1),
    (ItemKey.Meddlespread, ItemKey.Meddlespread): (ItemKey.SpeckledCapSpores, 0.3),
    (ItemKey.SpeckledCap, ItemKey.Meddlespread): (ItemKey.BloodcrownSpores, 0.25),
    (ItemKey.Bloodcrown, ItemKey.SpeckledCap): (ItemKey.FoolsDelightSpores, 0.2),
    (ItemKey.FoolsDelight, ItemKey.Bloodcrown): (ItemKey.SpidersGroveSpores, 0.05),
    (ItemKey.Bloodcrown, ItemKey.DawnsGlory): (ItemKey.BlazeClusterSpores, 0.15),
    (ItemKey.Seaclover, ItemKey.Sungrain): (ItemKey.GoldenCloverSeed, 0.05),
    (ItemKey.Meddlespread, ItemKey.Snowdew): (ItemKey.WanderweedSeed, 0.05),
    (ItemKey.GoldenClover, ItemKey.Apple): (ItemKey.GoldenCloverSeed, 0.05)
})
