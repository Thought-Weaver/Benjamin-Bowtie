...
MUTATION_PROBS: MappingProxyType[Tuple[ItemKey | Literal[""], ItemKey | Literal[""]], Tuple[ItemKey, float]] = MappingProxyType({
    ...
    (ItemKey.DreamMaker, ItemKey.Manabloom): (ItemKey.LichbloomSeed, 0.03),
    (ItemKey.Lichbloom, ItemKey.DragonsTeeth): (ItemKey.ForgottenTearsSeed, 0.04),
    ...
    (ItemKey.FoolsDelight, ItemKey.Bloodcrown): (ItemKey.SpidersGroveSpores, 0.06),
